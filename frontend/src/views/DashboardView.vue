<template>
  <div class="page-stack">
    <div class="metric-grid">
      ...
      <MetricTile label="Ready Batches" :value="stats.readyBatches ?? 0" icon="pi pi-clock" tone="amber" />
      <MetricTile label="Released" :value="stats.releasedBatches ?? 0" icon="pi pi-check-circle" tone="emerald" />
    ...
    <div class="surface-panel">
      ...
      <div class="surface-body quick-grid">
        ...
        <Button label="Payroll Batches" icon="pi pi-wallet" severity="secondary" outlined @click="$router.push('/payroll/batches')" />
